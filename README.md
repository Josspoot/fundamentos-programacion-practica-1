...
EN ESTE DOCUMENTO SE PUEDE ENCONTRAR LA RESOLUCION DE LOS EJERCICIOS PLANTEADOS EN LA MATERIA DE FUNDAMENTOS DE ALGEBRA DEL INSTITUTO TECNOLOGICO DE SOFTWARE 
...
### Lo que más me costó
- **Los ejercicios de matrices**: Entender como funcinan las matrices ya que igual apenas las estamos viendo en progrmacion
- **Factorial**: por el uso de cierta logica y recordar que era un factorial

### Lo que más me gustó
- **declaracion de variables**: a diferencia de otros lengajes de programacion la declaracion en js es diferente como todas, pero considero que es algo importante a tener en cuenta para poder desarrollar nuevos programas dependiendo de lo que se necesite.
- **if/else**: siento que es una de las cosas mas importantes para la programacion 
...
**Por qué me gusta:** por la facilidad que puede dar para resolver siertos problemas que se me puedan plantear 
...
Este proyecto me preparo para las siguientes cosas 
...
- **GitHub:** [@TU-USUARIO](https://github.com/josspoot)
